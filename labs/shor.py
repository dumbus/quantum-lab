...
if (student_id == 0):
  ...
  qc_qft_title = f"Квантовая схема для квантового преобразования Фурье с {REG_SIZE} кубитами"
  ...
  qc_title = "Квантовая схема для определения периода r функции f(x)=13^x mod 15"
  qc_qft_title = f"Квантовая схема для квантового преобразования Фурье с {REG_SIZE} кубитами"
  ...
  qc_title = "Квантовая схема для определения периода r функции f(x)=16^x mod 51"
  qc_qft_title = f"Квантовая схема для квантового преобразования Фурье с {REG_SIZE} кубитами"
  ...
  # Block 2
  qc.cx(q_reg_x[REG_MAX], q_reg_y[5])
  qc.cx(q_reg_x[REG_MAX], q_reg_y[1])
  ...
  qc_title = "Квантовая схема для определения периода r функции f(x)=2^x mod 15"
  qc_qft_title = f"Квантовая схема для квантового преобразования Фурье с {REG_SIZE} кубитами"
  ...
  qc_title = "Квантовая схема для определения периода r функции f(x)=35^x mod 51"
  qc_qft_title = f"Квантовая схема для квантового преобразования Фурье с {REG_SIZE} кубитами"
  ...
  # Block 2
  qc.cx(q_reg_x[REG_MAX], q_reg_y[4])
  qc.cx(q_reg_x[REG_MAX], q_reg_y[0])
  ...
  qc_title = "Квантовая схема для определения периода r функции f(x)=8^x mod 15"
  qc_qft_title = f"Квантовая схема для квантового преобразования Фурье с {REG_SIZE} кубитами"
  ...
  qc_title = "Квантовая схема для определения периода r функции f(x)=50^x mod 51"
  qc_qft_title = f"Квантовая схема для квантового преобразования Фурье с {REG_SIZE} кубитами"
